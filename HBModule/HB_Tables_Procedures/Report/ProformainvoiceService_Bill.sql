...
GO
IF EXISTS (SELECT * FROM dbo.SYSOBJECTS WHERE id = OBJECT_ID(N'[dbo].[SP_ProformainvoiceService_Bill]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[SP_ProformainvoiceService_Bill]
GO
/*=============================================
Author Name  : shameem
...
*******************************************************************************************************
-- =============================================*/
CREATE PROCEDURE [dbo].[SP_ProformainvoiceService_Bill]
...
--	CS.CheckOutHdrId =  @Id1
	...
	h.ChkOutTariffTotal as TotalTariff,h.ChkOutTariffLT as LuxuryTax,h.ChkOutTariffNetAmount as NetAmount,
	h.ChkOutTariffST2 as SerivceNet,h.ChkOutTariffST3 as SerivceTax,h.ChkOutTariffCess as Cess,
	h.ChkOutTariffHECess as HCess,h.ChkOutTariffSC as ServiceCharge,h.PIInvoice,
    ...
    t.TINNumber,t.CINNumber,h.CreatedDate,h.PIInvoice--,CS.ChkOutServiceNetAmount
