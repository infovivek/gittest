...
GO
IF EXISTS (SELECT * FROM dbo.SYSOBJECTS WHERE id = OBJECT_ID(N'[dbo].[SP_ProformaInvoiceExtChkOutTariff_Bill]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[SP_ProformaInvoiceExtChkOutTariff_Bill]
GO
/*=============================================
Author Name  : shameem
...
*******************************************************************************************************
-- =============================================*/
CREATE PROCEDURE [dbo].[SP_ProformaInvoiceExtChkOutTariff_Bill]
...
--	 Tariff Bill
	...
	LTAgreed DECIMAL(27,2),LTRack DECIMAL(27,2),STAgreed DECIMAL(27,2),STRack DECIMAL(27,2),PIINvoice NVARCHAR(100)) 
--'External Property'
	...
	CINNo , InVoicedate,AmtWords, LTAgreed,LTRack,STAgreed,STRack,PIINvoice)   
	...
	h.LTAgreedAmount,h.LTRackAmount,h.STAgreedAmount,h.STRackAmount,h.PIInvoice
...
--MMT	
	...
	Email ,CompanyName ,logo ,ChkinDT ,ChkoutDT ,CompanyAddress ,Address ,Invoice ,Cheque ,TaxNo ,
	Latepay ,Tin ,Taxablename ,ServiceTaxNo ,LTPer ,STPer,
	CINNo , InVoicedate,AmtWords, LTAgreed,LTRack,STAgreed,STRack,PIINvoice from #Prop1 
