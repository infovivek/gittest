...
GO
IF EXISTS (SELECT * FROM dbo.SYSOBJECTS WHERE id = OBJECT_ID(N'[dbo].[SP_ProformaInvoiceConsolidate_Bill]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[SP_ProformaInvoiceConsolidate_Bill]
GO
/*=============================================
Author Name  : shameem
...
*******************************************************************************************************
-- =============================================*/
CREATE PROCEDURE [dbo].[SP_ProformaInvoiceConsolidate_Bill]
...
DECLARE @CompanyName VARCHAR(100),@Address NVARCHAR(100),@PanCardNo VARCHAR(100),
	...
	h.ChkOutTariffLT as LuxuryTax,h.PIInvoice,
    ...
    'Service Charge  @ 2.5% on Tariff' ServChrg,'Service Tax@12.00% on ServiceCharge'ServChrg1
    ...
    t.TINNumber,t.CINNumber,h.PIInvoice
