...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[SP_PropertyWisePaymentType_Report]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
DROP PROCEDURE [dbo].[SP_PropertyWisePaymentType_Report]
GO 
--EXEC SP_PropertyWisePaymentType_Report @Action='PageLoad',@FromDt='2014-07-01',@ToDt ='2014-07-31',@ClientId = 2007
-- ===============================================================================
-- Author:Sakthi
-- Create date:23-AUG-2014
-- =================================================================================
CREATE PROCEDURE [dbo].[SP_PropertyWisePaymentType_Report](@Action NVARCHAR(100),
