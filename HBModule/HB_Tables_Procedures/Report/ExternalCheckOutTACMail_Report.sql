...
GO
IF EXISTS (SELECT * FROM dbo.SYSOBJECTS WHERE id = OBJECT_ID(N'[dbo].[SP_ExternalCheckOutTACMail_Report]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[SP_ExternalCheckOutTACMail_Report]
GO
/*=============================================
Author Name  : shameem
...
*******************************************************************************************************
-- =============================================*/
CREATE PROCEDURE [dbo].[SP_ExternalCheckOutTACMail_Report]
