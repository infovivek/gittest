...
GO
IF EXISTS (SELECT * FROM dbo.SYSOBJECTS WHERE id = OBJECT_ID(N'[dbo].[SP_ProformainvoiceExtChkOutConsolidate_Bill]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[SP_ProformainvoiceExtChkOutConsolidate_Bill]
GO
/*=============================================
Author Name  : shameem
...
*******************************************************************************************************
-- =============================================*/
CREATE PROCEDURE [dbo].[SP_ProformainvoiceExtChkOutConsolidate_Bill]
...
IF @Action='PageLoad'
	...
	set @ProType = (select top 1 PropertyType from WRBHBPreformaCheckOut where Id = @Id1 and 
	...
	ServChrg1 NVARCHAR(MAX),CessName NVARCHAR(MAX),HCessName NVARCHAR(MAX),PIInvoice NVARCHAR(100))
	...
	LaundryName ,ServiceName ,FoodBev  ,ServChrg1,CessName,HCessName,PIInvoice ) 
	...
	left outer join WRBHBPreformaCheckOutServiceHdr CS on h.Id = cs.CheckOutHdrId and CS.IsActive = 1 and cs.IsDeleted = 0
    ...
    h.LTRackAmount,h.STAgreedAmount,h.STRackAmount,h.PIInvoice--,t.LuxuryNo
...
-- MGH
    ...
    h.LTAgreedAmount,h.LTRackAmount,h.STAgreedAmount,h.STRackAmount,h.PIInvoice--,t.LuxuryNo
