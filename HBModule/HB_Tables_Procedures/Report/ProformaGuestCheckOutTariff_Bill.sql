...
GO
IF EXISTS (SELECT * FROM dbo.SYSOBJECTS WHERE id = OBJECT_ID(N'[dbo].[SP_ProformaGuestCheckOutTariff_Bill]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[SP_ProformaGuestCheckOutTariff_Bill]
GO
/*=============================================
Author Name  : shameem
...
*******************************************************************************************************
-- =============================================*/
CREATE PROCEDURE [dbo].[SP_ProformaGuestCheckOutTariff_Bill]
...
--	 Tariff Bill
	...
	WHERE H.Id=@ClientId
	 ...
	 convert(nvarchar(100),d.ArrivalDate,103)as ArrivalDate,  h.PIInvoice,
	 ...
	 select * from WRBHBPreformaCheckOut where Id = 10
END
END
