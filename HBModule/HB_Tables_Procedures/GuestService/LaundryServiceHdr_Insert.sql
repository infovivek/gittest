...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[SP_LaundryServiceHdr_Insert]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
	DROP PROCEDURE [dbo].[SP_LaundryServiceHdr_Insert]
GO
/*=============================================
Author Name  : Anbu
...
*******************************************************************************************************/
CREATE PROCEDURE [dbo].[SP_LaundryServiceHdr_Insert](@PropertyId BIGINT,
...
INSERT INTO WRBHBLaundrServiceHdr(PropertyId,PropertyName,Date,GuestName,GuestId,GetType,RoomNo,
