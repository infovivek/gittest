...
SET QUOTED_IDENTIFIER ON
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[SP_PreformaInvoiceSettleDtl_Insert]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
DROP PROCEDURE [dbo].[SP_PreformaInvoiceSettleDtl_Insert]
GO
/*=============================================
Author Name  : Anbu
...
*******************************************************************************************************
-- =============================================*/
CREATE PROCEDURE [dbo].[SP_PreformaInvoiceSettleDtl_Insert](@CheckOutSettleHdrId INT,
