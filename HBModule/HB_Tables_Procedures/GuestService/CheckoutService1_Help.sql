...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[Sp_CheckoutService1_Help]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
DROP PROCEDURE [dbo].[Sp_CheckoutService1_Help]
GO 
-- ===============================================================================
-- Author: Anbu
...
-- =================================================================================
CREATE PROCEDURE [dbo].[Sp_CheckoutService1_Help]
