...
GO
IF EXISTS (SELECT * FROM dbo.SYSOBJECTS WHERE id = OBJECT_ID(N'[dbo].[Sp_PreformaInvoiceEXTcheckout_Help]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[Sp_PreformaInvoiceEXTcheckout_Help]
GO
-- ===============================================================================
-- Author: Shameem
...
-- =================================================================================
CREATE PROCEDURE [dbo].[Sp_PreformaInvoiceEXTcheckout_Help]
...
--1 Room Level		
		...
		WHERE h.IsActive=1 AND h.IsDeleted=0 AND   
		h.PropertyType in ('External Property','MMT','CPP') and  
...
---upto this paid with flag 0 is taken  for else part of checkout   
      ...
      --Name  
		...
		JOIN WRBHBPreformaCheckOut D ON H.CheckOutHdrId = D.Id-- AND D.IsActive = 1 AND D.IsDeleted = 0  
		WHERE --H.IsActive=1 AND H.IsDeleted=0 AND 
		D.Id=@PropertyId;  
		-- CONSOLIDATE FOR ADD PAYMENTS  
