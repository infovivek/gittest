...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[Sp_ReassignProperty_Update]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
	DROP PROCEDURE [dbo].[Sp_ReassignProperty_Update]
GO   
/* 
        Author Name : <Anbu.P>
	...
	*******************************************************************************************************
*/
CREATE PROCEDURE [dbo].[Sp_ReassignProperty_Update] (
@Id					BIGINT,
