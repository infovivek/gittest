...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'Sp_TravelDesk_Insert') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
	DROP PROCEDURE Sp_TravelDesk_Insert;
GO   
/* 
        Author Name : Mini
	...
	*******************************************************************************************************
*/
CREATE PROCEDURE  Sp_TravelDesk_Insert
( 
...
ELSE  
	BEGIN  
	update WRBHBTravelDesk set Password= null, IsActive=0,ModifiedDate=GETDATE() where Email=@Email and Mode='ENDUSER'
