...
@FromDt date,@ToDt date,@ClientId BIGINT,@UserId INT)
AS
BEGIN
SET NOCOUNT ON
...
IF @Action = 'PageLoad1'
 BEGIN
  ...
  CREATE TABLE #Client(ClientName NVARCHAR(100),Id Int)
 
  INSERT INTO #Client(ClientName,Id)
  SELECT C.ClientName,C.Id FROM WRBHBClientManagement  C
  JOIN WRBHBTravelDesk T ON C.Id=T.ClientId AND T.IsActive=1 AND T.IsDeleted=0 AND T.Designation='Client'
  WHERE C.IsActive=1 AND C.IsDeleted=0 AND T.Id=@UserId 
  ORDER BY ClientName ASC 
  
  INSERT INTO #Client(ClientName,Id)
  SELECT C.ClientName,C.Id FROM WRBHBClientManagement  C
  JOIN WRBHBTravelDesk T  ON C.MasterClientId=T.ClientId AND T.IsActive=1 AND T.IsDeleted=0 AND T.Designation='MasterClient'
  WHERE C.IsActive=1 AND C.IsDeleted=0 AND T.Id=@UserId 
  ORDER BY ClientName ASC 
  
  SELECT ClientName,Id FROM #Client
  ORDER BY ClientName ASC 
 END
 ...
 IF(@Str='CurrentMonth')
	BEGIN
		...
		SET @ToDt =CONVERT(date,DATEADD(dd,-(DAY(DATEADD(mm,1,GETDATE()))),DATEADD(mm,1,GETDATE())),103)
		SET @FromDt = CONVERT(date,DATEADD(dd,-(DAY(@mydate)-1),@mydate),103)
		--Set @MonthWise=1;
		
	END
	IF(@Str='Last 3 Months')
		BEGIN
		--DECLARE @FromDate date, @ToDate date

		SET @ToDt = Convert(date,GETDATE(),103)
		SET @FromDt = Convert(date,DATEADD(MONTH, -3, GETDATE()),103)
		--Set @MonthWise=3;
	...
	BEGIN
		...
		SET @ToDt = Convert(date,GETDATE(),103)
		SET @FromDt = Convert(date,DATEADD(MONTH, -6, GETDATE()),103)
		--Set @MonthWise=6;
  ...
  PG.ChkInDt BETWEEN @FromDt AND @ToDt;
  ...
  BP.IsActive=1 AND BP.IsDeleted=0 AND PG.Tariff != 0 AND
  BP.PropertyType IN ('ExP','InP','CPP') AND
  PG.ChkOutDt BETWEEN @FromDt AND @ToDt;
  ...
  BP.IsActive=1 AND BP.IsDeleted=0 AND PG.Tariff != 0 AND
  BP.PropertyType IN ('ExP','InP','CPP') AND
  PG.ChkInDt BETWEEN @FromDt AND @ToDt AND
  PG.ChkOutDt BETWEEN @FromDt AND @ToDt;
  /*CAST(CAST(PG.ChkInDt AS VARCHAR)+' '+
  CAST(PG.ExpectChkInTime+' '+PG.AMPM AS VARCHAR) AS DATETIME) BETWEEN 
  ...
  BP.IsActive=1 AND BP.IsDeleted=0 AND PG.Tariff != 0 AND
  BP.PropertyType IN ('ExP','InP','CPP') AND
  PG.ChkInDt <= @FromDt AND PG.ChkOutDt >= @FromDt;
  /*CAST(CAST(PG.ChkInDt AS VARCHAR)+' '+
  ...
  --
  --select BookingId from #TMP group by BookingId;return;
  -- ROOM END
  -- BED BEGIN
  INSERT INTO #TMP(BookingId,BookingLevel,BookingCode,ChkInDt,ChkOutDt,
  Tariff,TariffPaymentMode,RoomCaptured,RoomId,RoomShiftingFlag)
  ...
  DECLARE @AddCnt INT;
  SET @MonthCnt = (SELECT DATEDIFF(MONTH,@FromDt,@ToDt));
  SET @AddCnt = 0;
  SET @F = @FromDt;
   ...
   BEGIN
    ...
    WHILE @MonthCnt > @AddCnt
     BEGIN
      ...
      SET @AddCnt += 1;
      IF MONTH(@F) = MONTH(@ToDt) AND YEAR(@F) = YEAR(@ToDt)
       BEGIN
        SET @F = @ToDt;
       END
     END
  ...
  WHERE N.Dt BETWEEN @FromDt AND @ToDt
  ...
  IF @FinalCnt = 1
   BEGIN
    ...
    CREATE TABLE  #Export1(CityName NVARCHAR(100),PropertyName NVARCHAR(100),M1BTC NVARCHAR(100),
    M1DIRECT NVARCHAR(100),M1BILLTOCLIENT NVARCHAR(100),M1Tot NVARCHAR(100),GrandTotal NVARCHAR(100),Flag INT)
    
    INSERT INTO #Export1(CityName,PropertyName,M1BTC,M1DIRECT,M1BILLTOCLIENT,M1Tot,GrandTotal,Flag)
    SELECT '','PROPERTY WISE PAYMENT REPORT','',
    (Convert(NVARCHAR,DATEADD(MONTH, -1, GETDATE()),103)+' TO '+Convert(NVARCHAR,GETDATE(),103)),'','','',1
   
    INSERT INTO #Export1(CityName,PropertyName,M1BTC,M1DIRECT,M1BILLTOCLIENT,M1Tot,GrandTotal,Flag)
    SELECT '','','',((LEFT(DATENAME(MONTH,DATEADD(MONTH,-1,GETDATE())),10))+'-'+CONVERT(NVARCHAR,YEAR(GETDATE()),103)),'','','',2
     INSERT INTO #Export1(CityName,PropertyName,M1BTC,M1DIRECT,M1BILLTOCLIENT,M1Tot,GrandTotal,Flag)
    SELECT 'CityName','Property/HotalName','DIRECT','BTC','BILLTOCLIENT','TOTAL','GRANDTOTAL',3
    ...
    M1BILLTOCLIENT,
    CASE WHEN M1Tot != '0.00' THEN M1Tot ELSE '' END AS M1Tot,
    CASE WHEN GrandTotal != '0.00' THEN GrandTotal ELSE '' END AS GrandTotal,4
    FROM #FINAL ORDER BY CityName,PropertyName ASC;
    ...
    M1BILLTOCLIENT,
    CASE WHEN GrandTotal != '0.00' THEN GrandTotal ELSE '' END AS GrandTotal
    FROM #Export1 ORDER BY Flag ASC;
  ...
  IF @FinalCnt = 4
   BEGIN
    ...
    CREATE TABLE  #Export2(CityName NVARCHAR(100),PropertyName NVARCHAR(100),M1BTC NVARCHAR(100),
    M1DIRECT NVARCHAR(100),M1BILLTOCLIENT NVARCHAR(100),M2BTC NVARCHAR(100),
    M2DIRECT NVARCHAR(100),M2BILLTOCLIENT NVARCHAR(100),M3BTC NVARCHAR(100),
    M3DIRECT NVARCHAR(100),M3BILLTOCLIENT NVARCHAR(100),
    GrandTotal NVARCHAR(100),Flag INT)
    
    INSERT INTO #Export2(CityName,PropertyName,M1BTC,M1DIRECT,M1BILLTOCLIENT,M2BTC,M2DIRECT,M2BILLTOCLIENT,
    M3BTC,M3DIRECT,M3BILLTOCLIENT,GrandTotal,Flag)
    SELECT '','','','','PROPERTY WISE PAYMENT REPORT',(Convert(NVARCHAR,DATEADD(MONTH, -3, GETDATE()),103)+' TO '+Convert(NVARCHAR,GETDATE(),103)),'','',
    '','','','',1
   
    INSERT INTO #Export2(CityName,PropertyName,M1BTC,M1DIRECT,M1BILLTOCLIENT,M2BTC,M2DIRECT,M2BILLTOCLIENT,
    M3BTC,M3DIRECT,M3BILLTOCLIENT,GrandTotal,Flag)
    SELECT '','','',((LEFT(DATENAME(MONTH,DATEADD(MONTH,-1,GETDATE())),10))+'-'+CONVERT(NVARCHAR,YEAR(GETDATE()),103)),'','',
    ((LEFT(DATENAME(MONTH,DATEADD(MONTH,-2,GETDATE())),10))+'-'+CONVERT(NVARCHAR,YEAR(CONVERT(NVARCHAR,DATEADD(MONTH, -2, GETDATE()),103)),103)),'','',
    ((LEFT(DATENAME(MONTH,DATEADD(MONTH,-3,GETDATE())),10))+'-'+CONVERT(NVARCHAR,YEAR(CONVERT(NVARCHAR,DATEADD(MONTH, -3, GETDATE()),103)),103)),'','',2
    
    INSERT INTO #Export2(CityName,PropertyName,M1BTC,M1DIRECT,M1BILLTOCLIENT,M2BTC,M2DIRECT,M2BILLTOCLIENT,
    M3BTC,M3DIRECT,M3BILLTOCLIENT,GrandTotal,Flag)
    SELECT 'CityName','Property/HotalName','DIRECT','BTC','BILLTOCLIENT','DIRECT','BTC','BILLTOCLIENT','DIRECT','BTC','BILLTOCLIENT','GRANDTOTAL',3
    ...
    CASE WHEN M1DIRECT != '0.00' THEN M1DIRECT ELSE '' END AS M1DIRECT,
    CASE WHEN M1BILLTOCLIENT != '0.00' THEN M1BILLTOCLIENT ELSE '' END AS 
    M1BILLTOCLIENT,CASE WHEN M2BTC != '0.00' THEN M2BTC ELSE '' END AS M2BTC,
    CASE WHEN M2DIRECT != '0.00' THEN M2DIRECT ELSE '' END AS M2DIRECT,
    CASE WHEN M2BILLTOCLIENT != '0.00' THEN M2BILLTOCLIENT ELSE '' END AS 
    M2BILLTOCLIENT,CASE WHEN M3BTC != '0.00' THEN M3BTC ELSE '' END AS M3BTC,
    CASE WHEN M3DIRECT != '0.00' THEN M3DIRECT ELSE '' END AS M3DIRECT,
    CASE WHEN M3BILLTOCLIENT != '0.00' THEN M3BILLTOCLIENT ELSE '' END AS 
    M3BILLTOCLIENT,
    CASE WHEN GrandTotal != '0.00' THEN GrandTotal ELSE '' END AS GrandTotal,4
    ...
    M3BILLTOCLIENT,
    CASE WHEN GrandTotal != '0.00' THEN GrandTotal ELSE '' END AS GrandTotal
    FROM #Export2 ORDER BY Flag ASC; 
  ...
  IF @FinalCnt = 7
   BEGIN
    ...
    CREATE TABLE  #Export3(CityName NVARCHAR(100),PropertyName NVARCHAR(100),M1BTC NVARCHAR(100),
    M1DIRECT NVARCHAR(100),M1BILLTOCLIENT NVARCHAR(100),M2BTC NVARCHAR(100),
    M2DIRECT NVARCHAR(100),M2BILLTOCLIENT NVARCHAR(100),M3BTC NVARCHAR(100),
    M3DIRECT NVARCHAR(100),M3BILLTOCLIENT NVARCHAR(100),M4BTC NVARCHAR(100),
    M4DIRECT NVARCHAR(100),M4BILLTOCLIENT NVARCHAR(100),M5BTC NVARCHAR(100),
    M5DIRECT NVARCHAR(100),M5BILLTOCLIENT NVARCHAR(100),M6BTC NVARCHAR(100),
    M6DIRECT NVARCHAR(100),M6BILLTOCLIENT NVARCHAR(100),
    GrandTotal NVARCHAR(100),Flag INT)
    
    INSERT INTO #Export3(CityName,PropertyName,M1BTC,M1DIRECT,M1BILLTOCLIENT,M2BTC,M2DIRECT,M2BILLTOCLIENT,
    M3BTC,M3DIRECT,M3BILLTOCLIENT,M4BTC,M4DIRECT,M4BILLTOCLIENT,M5BTC,M5DIRECT,M5BILLTOCLIENT,
    M6BTC,M6DIRECT,M6BILLTOCLIENT,GrandTotal,Flag)
    SELECT '','','','','','','','',
    '','PROPERTY WISE PAYMENT REPORT',(Convert(NVARCHAR,DATEADD(MONTH, -6, GETDATE()),103)+' TO '+Convert(NVARCHAR,GETDATE(),103)),
    '','','','','','','','','','',1
    ...
    SELECT '','','',((LEFT(DATENAME(MONTH,DATEADD(MONTH,-1,GETDATE())),10))+'-'+CONVERT(NVARCHAR,YEAR(GETDATE()),103)),'','',
    ((LEFT(DATENAME(MONTH,DATEADD(MONTH,-2,GETDATE())),10))+'-'+CONVERT(NVARCHAR,YEAR(CONVERT(NVARCHAR,DATEADD(MONTH, -2, GETDATE()),103)),103)),'','',
    ((LEFT(DATENAME(MONTH,DATEADD(MONTH,-3,GETDATE())),10))+'-'+CONVERT(NVARCHAR,YEAR(CONVERT(NVARCHAR,DATEADD(MONTH, -3, GETDATE()),103)),103)),'','',
    ((LEFT(DATENAME(MONTH,DATEADD(MONTH,-4,GETDATE())),10))+'-'+CONVERT(NVARCHAR,YEAR(CONVERT(NVARCHAR,DATEADD(MONTH, -4, GETDATE()),103)),103)),'','',
    ((LEFT(DATENAME(MONTH,DATEADD(MONTH,-5,GETDATE())),10))+'-'+CONVERT(NVARCHAR,YEAR(CONVERT(NVARCHAR,DATEADD(MONTH, -5, GETDATE()),103)),103)),'','',
    ((LEFT(DATENAME(MONTH,DATEADD(MONTH,-6,GETDATE())),10))+'-'+CONVERT(NVARCHAR,YEAR(CONVERT(NVARCHAR,DATEADD(MONTH, -6, GETDATE()),103)),103)),'','',2
    
    INSERT INTO #Export3(CityName,PropertyName,M1BTC,M1DIRECT,M1BILLTOCLIENT,M2BTC,M2DIRECT,M2BILLTOCLIENT,
    M3BTC,M3DIRECT,M3BILLTOCLIENT,M4BTC,M4DIRECT,M4BILLTOCLIENT,M5BTC,M5DIRECT,M5BILLTOCLIENT,
    M6BTC,M6DIRECT,M6BILLTOCLIENT,GrandTotal,Flag)
    SELECT 'CityName','Property/HotalName','DIRECT','BTC','BILLTOCLIENT','DIRECT','BTC','BILLTOCLIENT','DIRECT','BTC','BILLTOCLIENT',
    'DIRECT','BTC','BILLTOCLIENT','DIRECT','BTC','BILLTOCLIENT','DIRECT','BTC','BILLTOCLIENT','GRANDTOTAL',3
    ...
    M6BILLTOCLIENT,
    CASE WHEN GrandTotal != '0.00' THEN GrandTotal ELSE '' END AS GrandTotal
    FROM #Export3 ORDER BY Flag ASC;  
   END
  IF @FinalCnt = 8
   BEGIN
    SELECT CityName,PropertyName,
