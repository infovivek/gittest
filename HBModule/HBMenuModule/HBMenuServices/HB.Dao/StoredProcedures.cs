...
namespace HB.Dao
{
    ...
    {
        //MenuScreen
        public const string MenuScreen_Help = "HBMenu_MenuScreen_Help";

        public const string ChangePassword_help = "HBMenu_ChangePassword_help";


        public const string ForgotPassword_Select = "HBMenu_ForgotPassword_Select"; 

        //ImportExcel
        public const string Excel_Insert = "Sp_ExcelProperty_Insert";

        //Paymentwise Report
        public const string PaymentWiseService_Help = "HBMenu_PropertyWisePaymentType_Report";

        //Paymentwise Report
        public const string PropertyWiseService_Help = "HBMenu_PropertyWiseService_Report";
