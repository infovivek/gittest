...
namespace HB.Dao
{
    public class ForgotDAO
    {
        ...
        {
            UserData = " UserId:" + user.Id + ", UsreName:" + user.LoginUserName + ", ScreenName:'" + user.ScreenName +
                 "', SctId:" + user.SctId + ", Service:ForgotDAO Select" + ", ProcName:'" + StoredProcedures.ForgotPassword_Select; 

            DataSet ds = new DataSet();
             Cmd = new SqlCommand();
             Cmd.CommandText = StoredProcedures.ForgotPassword_Select;
            ...
            if ((ds.Tables[0].Rows[0][0].ToString() != "EmailId Is Incorrect"))
            {
                ...
                message.From = new System.Net.Mail.MailAddress("password@hummingbirdindia.com", "HB Password Reset", System.Text.Encoding.UTF8);
