...
{
    public class TIAandATIAService:IBusinessService
    {
        ...
        public DataSet Save(string[] data, Entity.User user)
        {
            ...
            try
            {
                ...
                DataSet ds1 = new TIAandATIABO().Save(data, user);
        ...
        public DataSet Delete(string[] data, User user)
        {
            ...
            DataTable dTable = new DataTable("ERRORTBL");
            dTable.Columns.Add("Exception");
            DataSet ds1 = new TIAandATIABO().Delete(data, user);
            ds.Tables.Add(dTable);
            return ds;
        }
        ...
        {
            return new TIAandATIABO().Search(data, user);
        }
        ...
        public DataSet HelpResult(string[] data, Entity.User user)
        {
            ...
            DataSet ds1 = new TIAandATIABO().Help(data, user);
            return ds1;
        }
    }
}
