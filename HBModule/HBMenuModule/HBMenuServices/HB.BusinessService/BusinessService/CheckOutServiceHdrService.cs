...
{
    public class CheckOutServiceHdrService : IBusinessService
    {
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                ds = new CheckOutServiceHdrBO().Save(Hdrval, user);
        ...
        {
            return new CheckOutServiceHdrBO().HelpResult(data, user);
