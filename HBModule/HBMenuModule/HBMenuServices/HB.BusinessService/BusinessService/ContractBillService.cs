...
{
    public class ContractBillService : IBusinessService
    {
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                ds = new ContractBillBO().Save(data, user);
        ...
        {
            return new ContractBillBO().Search(data, user);
        }
        public DataSet HelpResult(string[] data, User user)
        {
            ...
            DataSet ds1 = new ContractBillBO().Help(data, user);
            return ds1;
        }
    }
}
