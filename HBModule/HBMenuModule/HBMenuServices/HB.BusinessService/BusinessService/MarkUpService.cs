...
{
    public class MarkUpService:IBusinessService
    {
        public DataSet Save(string[] data, Entity.User user)
        {
            ...
            try
            {
                ...
                DataSet ds1 = new MarkUpBO().Save(data, user);
        ...
        public DataSet Delete(string[] data, Entity.User user)
        {
            ...
            DataTable dTable = new DataTable("ERRORTBL");
            dTable.Columns.Add("Exception");
            DataSet ds1 = new MarkUpBO().Delete(data, user);
            ds.Tables.Add(dTable);
            return ds;
        }
        ...
        {
            return new MarkUpBO().Search(data, user);
        }

        public DataSet HelpResult(string[] data, Entity.User user)
        {
            return new MarkUpBO().HelpResult(data, user);
        }
    }
}
