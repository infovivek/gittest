...
{
    public class TDSDeclarationService:IBusinessService
    {
        public DataSet Save(string[] data, Entity.User user)
        {
            ...
            try
            {
                ...
                DataSet ds1 = new TDSDeclarationBO().Save(data, user);
        ...
        public System.Data.DataSet Delete(string[] data, Entity.User user)
        {
            ...
            DataTable dTable = new DataTable("ERRORTBL");
            dTable.Columns.Add("Exception");
            DataSet ds1 = new TDSDeclarationBO().Delete(data, user);
            ds.Tables.Add(dTable);
            return ds;
        }
        ...
        {
            return new TDSDeclarationBO().Search(data, user);
        }
        ...
        public System.Data.DataSet HelpResult(string[] data, Entity.User user)
        {
            ...
            DataSet ds1 = new TDSDeclarationBO().Help(data, user);
            return ds1;
        }
    }
}
