...
{
    public class NewKOTEntryService : IBusinessService
    {
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                ds = new NewKOTEntryHdrBO().Save(data, user);
                ...
                else
                {
                    ...
                    DataSet ds1 = new NewKOTEntryDtlBO().Save(NewKOTEntryHdr, user, NewKOTEntryHdrId);
        ...
        {
            return new NewKOTEntryHdrBO().Search(data, user);
        }

        public DataSet HelpResult(string[] data, User user)
        {
            return new NewKOTEntryHdrBO().HelpResult(data, user);
        }
    }
}
