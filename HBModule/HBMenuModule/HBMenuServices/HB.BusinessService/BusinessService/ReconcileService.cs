...
{
    public class ReconcileService:IBusinessService
    {
        public System.Data.DataSet Save(string[] data, Entity.User user)
        {
            ...
            try
            {
                ...
                DataSet ds1 = new ReconcileBO().Save(data, user);
        ...
        {
            return new ReconcileBO().Search(data, user);
        }
        ...
        public System.Data.DataSet HelpResult(string[] data, Entity.User user)
        {
            ...
            DataSet ds1 = new ReconcileBO().Help(data, user);
            return ds1;
        }
    }
}
