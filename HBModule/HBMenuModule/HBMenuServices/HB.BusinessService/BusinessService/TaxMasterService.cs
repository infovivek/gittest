...
{
    public class TaxMasterService : IBusinessService
    {
        public DataSet Save(string[] data, User user = default(User))
        {
            ...
            try
            {
                ds = new TaxMasterBo().Save(data, user);
        ...
        public DataSet Delete(string[] data, User user = default(User))
        {
            ...
            DataTable dTable = new DataTable("ERRORTBL");
            dTable.Columns.Add("Exception");
            DataSet ds1 = new TaxMasterBo().Delete(data, user);
        ...
        {
            return new TaxMasterBo().Search(data, user);
        }

        public DataSet HelpResult(string[] data, User user)
        {
            return new TaxMasterBo().Help(data, user);
        }
    }
 }
