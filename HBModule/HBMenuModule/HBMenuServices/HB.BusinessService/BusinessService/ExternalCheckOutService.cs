...
{
    public class ExternalCheckOutService:IBusinessService
    {
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                //Hdrval = data[2].ToString();
                ds = new ExternalCheckOutBO().Save(data, user);
        ...
        {
            return new ExternalCheckOutBO().Search(data, user);
        }

        public DataSet HelpResult(string[] data, User user)
        {
            return new ExternalCheckOutBO().HelpResult(data, user);
        }
    }
}
