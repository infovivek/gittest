...
namespace HB.Dao
{
    public class FormatReceiptsDAO
    {
         string UserData;
        public DataSet Help(string[] data, User user)
        {
            UserData = " UserId:" + user.Id + ", UsreName:" + user.LoginUserName + ", ScreenName:'" + user.ScreenName +
       "', SctId:" + user.SctId + ", Service:FormatReceiptsDAO Help" + ", ProcName:'" + StoredProcedures.FormatReceipts_Help; 

            SqlCommand command = new SqlCommand();
            command.CommandText = StoredProcedures.FormatReceipts_Help;
