...
namespace HB.Dao
{
  public  class SearchInvoiceReportDao
    {
        public DataSet Help(string[] data, User user)
        {
            ...
            command.CommandText = StoredProcedures.SearchInvoiceReport_Help;
            ...
            command.Parameters.Add("@Id1", SqlDbType.BigInt).Value = Convert.ToInt32(data[7].ToString());
            command.Parameters.Add("@Id2", SqlDbType.BigInt).Value = Convert.ToInt32(data[8].ToString());
            command.Parameters.Add("@Id3", SqlDbType.BigInt).Value = Convert.ToInt32(data[9].ToString());
