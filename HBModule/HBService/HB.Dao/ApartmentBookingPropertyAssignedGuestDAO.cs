...
namespace HB.Dao
{
    public class ApartmentBookingPropertyAssignedGuestDAO
    {
        String UserData;
        public DataSet Save(string PropertyAssignedGuest, User user, int BookingId)
        {
            ...
            ApartmentBookingPropertyAssignedGuest PtoG = new ApartmentBookingPropertyAssignedGuest();
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                PtoG.ApartmentType = document.SelectNodes("//GridXml")[i].Attributes["ApartmentType"].Value;
                PtoG.Tariff = Convert.ToDecimal(document.SelectNodes("//GridXml")[i].Attributes["Tariff"].Value);
                PtoG.ApartmentId = Convert.ToInt32(document.SelectNodes("//GridXml")[i].Attributes["ApartmentId"].Value);
                ...
                //        "', SctId:" + user.SctId + ", Service:ApartmentBookingPropertyAssignedGuestDAO Update"
                 //       + ", ProcName:'" + StoredProcedures.BookingCustomFieldsDetails_Update; 
                ...
                {
                    UserData = " UserId:" + user.Id + ", UsreName:" + user.LoginUserName + ", ScreenName:'" + user.ScreenName +
                        "', SctId:" + user.SctId + ", Service:ApartmentBookingPropertyAssignedGuestDAO Insert"
                        + ", ProcName:'" + StoredProcedures.ApartmentBookingPropertyAssingedGuest_Insert; 

                    command.CommandText = StoredProcedures.ApartmentBookingPropertyAssingedGuest_Insert;
                }
                ...
                command.Parameters.Add("@ApartmentType", SqlDbType.NVarChar).Value = PtoG.ApartmentType;
                command.Parameters.Add("@Tariff", SqlDbType.Decimal).Value = PtoG.Tariff;
                command.Parameters.Add("@ApartmentId", SqlDbType.BigInt).Value = PtoG.ApartmentId;
