...
namespace HB.Dao
{
   public class TodaysCheckinCheckoutDAO
    {

        public DataSet Help(string[] data, User user)
        {
            string UserData = "UserId : " + user.Id + ", UsreName : " + user.LoginUserName + ", ScreenName : '" + user.ScreenName +
            "', SctId : " + user.SctId + ", Service :TodaysCheckinChkout_Help DAO" + ", ProcName : '" + StoredProcedures.TodaysCheckinChkout_Help;
            SqlCommand command = new SqlCommand();
            command.CommandText = StoredProcedures.TodaysCheckinChkout_Help; 
