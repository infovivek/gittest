...
namespace HB.Dao
{
    public class ApartmentBookingMailDAO
    {
        String UserData;
        ...
        public DataSet Mail(int BookingId, User user)
        {
            ...
            catch (Exception ex)
            {
                ...
                log.ErrorLog(ex.Message + " --> Apartment Level Booking Confirmation Mail --> " + message.Subject);
            }
            /*if (ds.Tables[10].Rows.Count > 0)
            {
            ...
            if (ds.Tables[3].Rows.Count > 0)
            {
                if (ds.Tables[3].Rows[0][4].ToString() != "")
                {
                    ...
                    //message1.Subject = "Apartment Property Booking Confirmation - " + ds.Tables[2].Rows[0][2].ToString();
                    for (int i = 0; i < cnt; i++)
                    {
                    ...
                    smtp1.Host = "email-smtp.us-west-2.amazonaws.com";
                    smtp1.Port = 587;
                    smtp1.Credentials = new System.Net.NetworkCredential("AKIAIIVF5D5D3CJAX7SQ", "ApmuZkd+L8tissEga8kac3quhhwohEi5CB+dYD36KTq3");
                    try
                    {
                        smtp1.Send(message1);
                    }
                    ...
                    {
                        CreateLogFiles log = new CreateLogFiles();
                        log.ErrorLog(ex.Message + " --> Apartment Level Booking Confirmation Property Mail --> " + message1.Subject);
                    }
                    /*if (ds.Tables[10].Rows.Count > 0)
                    {
