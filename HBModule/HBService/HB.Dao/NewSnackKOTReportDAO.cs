...
namespace HB.Dao
{
   public class NewSnackKOTReportDAO
    {
        string UserData;
       ...
       public DataSet HelpResult(string[] data, User user)
       {
           UserData = " UserId:" + user.Id + ", UsreName:" + user.LoginUserName + ", ScreenName:'" + user.ScreenName +
              "', SctId:" + user.SctId + ", Service:NewSnackKOTReportDAO Help" + ", ProcName:'" + StoredProcedures.NewSnackKOTEntryReport_Help;
           
           command = new SqlCommand();
           command.CommandText = StoredProcedures.NewSnackKOTEntryReport_Help;
