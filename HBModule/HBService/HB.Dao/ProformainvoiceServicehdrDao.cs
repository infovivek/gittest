...
namespace HB.Dao
{
    public class ProformainvoiceServicehdrDao
    {
        string UserData;
        ...
        public DataSet Save(string Hdrval, User user)
        {
            ...
            ProformainvoiceServicehdr ChkOutSer = new ProformainvoiceServicehdr();
            ...
            {
                UserData = " UserId:" + user.Id + ", UsreName:" + user.LoginUserName + ", ScreenName:'" + user.ScreenName +
                 "', SctId:" + user.SctId + ", Service:CheckOutHdrService_Insert" + ", ProcName:'" + StoredProcedures.PreformaInvoiceServiceHdr_Insert;

                Mode = "Save";
                Cmd.CommandText = StoredProcedures.PreformaInvoiceServiceHdr_Insert;
        ...
        {
            UserData = " UserId:" + User.Id + ", UsreName:" + User.LoginUserName + ", ScreenName:'" + User.ScreenName +
                 "', SctId:" + User.SctId + ", Service:CheckOutHdrService_Help" + ", ProcName:'" + StoredProcedures.ProformaInvoiceService_Help;
            Cmd = new SqlCommand();
            Cmd.CommandText = StoredProcedures.ProformaInvoiceService_Help;
            Cmd.CommandType = CommandType.StoredProcedure;
