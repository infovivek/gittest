...
namespace HB.Dao
{
    public class CheckOutandInterSettleHdrDao
    {
        string UserData;
        ...
        public DataSet Save(string Hdrval, User user)
        {
            ...
            CheckOutandInterSettleHdr ChkOutSet = new CheckOutandInterSettleHdr();
            ...
            ChkOutSet.EmailId = doc.SelectSingleNode("HdrXml").Attributes["EmailId"].Value;
            Cmd = new SqlCommand();
            if (ChkOutSet.Id != 0)
            {
            ...
            //{
                ...
                if ((ds.Tables[0].Rows[0][0].ToString() != "UserName or EmailId Already Exist"))
                {
                    ...
                    string AddressDtls =
                               ...
                               "<span>Dear   <B> "+ ChkOutSet.PayeeName + " , </B></span> " + " <br>" +
                               " </p>" +
                               ...
                               "<a href=\"http://sstage.in/Form?data=398EC317-23C5-4DC9-B254-A9B39E128507\" target=\"_blank\" style=\"font-size:16px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:40px; width:100%; display:inline-block\"><span style=\"color: #FFFFFF\">Leave Feedback</span></a>" +
                               "</td></tr> " +
