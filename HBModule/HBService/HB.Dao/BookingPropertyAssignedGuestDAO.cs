...
namespace HB.Dao
{
    public class BookingPropertyAssignedGuestDAO
    {
        string UserData = "";
        public DataSet Save(string PropertyAssignedGuest, User user, int BookingId)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                PtoG.Occupancy = document.SelectNodes("//GridXml")[i].Attributes["Occupancy"].Value;
                PtoG.RoomType = document.SelectNodes("//GridXml")[i].Attributes["RoomType"].Value;
                ...
                PtoG.BookingPropertyId = Convert.ToInt64(document.SelectNodes("//GridXml")[i].Attributes["BookingPropertyId"].Value);
                ...
                {
                    command.CommandText = StoredProcedures.BookingPropertyAssingedGuest_Insert;
                    UserData = " UserId:" + user.Id + ", UsreName:" + user.LoginUserName + ", ScreenName:'" + user.ScreenName +
             "', SctId:" + user.SctId + ", Service : BookingPropertyAssignedGuestDAO : Insert, " + ", ProcName:'" + StoredProcedures.BookingPropertyAssingedGuest_Insert; 
                }
                ...
                command.Parameters.Add("@Occupancy", SqlDbType.NVarChar).Value = PtoG.Occupancy;
                command.Parameters.Add("@RoomType", SqlDbType.NVarChar).Value = PtoG.RoomType;
...
/*
            else
            {
                ...
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add("@Action", SqlDbType.NVarChar).Value = "BookingConform";
                ...
                message.From = new System.Net.Mail.MailAddress("bookingconfirmation@staysimplyfied.com", "", System.Text.Encoding.UTF8);
                ...
                else if (DSBooking.Tables[1].Rows[0][6].ToString() == "External Property")
                {
                    if (DSBooking.Tables[1].Rows[0][11].ToString() == "Serviced Appartments")
                    {
                        Note = "This booking entitles you to use only the allotted room during your stay. There may be guests staying in the other rooms of the apartment. The allotted room could have an attached or a non-attached bath. The non-attached bath will be in the same apartment.";
                    }
                    else
...
*/
                ...
                if (DSBooking.Tables[3].Rows.Count > 0)
                {
                    if (DSBooking.Tables[3].Rows[0][2].ToString() != "")
                    {
                        System.Net.Mail.MailMessage message1 = new System.Net.Mail.MailMessage();                        
                        message.From = new System.Net.Mail.MailAddress("" + DSBooking.Tables[2].Rows[0][4].ToString() + "", "", System.Text.Encoding.UTF8);
                        message.To.Add(new System.Net.Mail.MailAddress("sakthi@warblerit.com"));
                        message.To.Add(new System.Net.Mail.MailAddress(DSBooking.Tables[3].Rows[0][2].ToString()));                        
                        message.Bcc.Add(new System.Net.Mail.MailAddress("vivek@admonk.in"));
                        message.Bcc.Add(new System.Net.Mail.MailAddress("prabathkar@admonk.in"));
                        message.Bcc.Add(new System.Net.Mail.MailAddress("deepak@admonk.in"));
                        message.Bcc.Add(new System.Net.Mail.MailAddress("sakthi@warblerit.com"));
                        message.Bcc.Add(new System.Net.Mail.MailAddress("arun@warblerit.com"));
                        message.Subject = "Booking Confirmation";
                        string Imagelocation1 = Imagelocation = DSBooking.Tables[6].Rows[0][0].ToString();                        
                        string Imagebody1 =
                        " <table cellpadding=\"0\" cellspacing=\"0\" width=\"600\" border=\"0\" align=\"center\" style=\" position: relative; font-family:  arial, helvetica; font-size: 12px;  border: #cccdcf solid 1px\">" +
                        " <tr><td><table cellpadding=\"0\" cellspacing=\"0\" width=\"600\" border=\"0\" align=\"center\">" +
                        " <tr><td width=\"600\" align=\"left\" style=\"padding: 10px 0px 10px 10px;\"> " +
                        ...
                        string SecondRow1 =
                            ...
                            " <p style=\"font-weight:bold; color:orange;\">Booking confirmation details" +
                            " <span style=\"color:#fff; background-color:#ffcc00; padding:5px;\">Booking # : " + DSBooking.Tables[2].Rows[0][2].ToString() + " </span></p>" + //Reservation                                       
                            " <p style=\"margin:0px;\">Reservation Date: <span>" + DSBooking.Tables[2].Rows[0][7].ToString() + "</span></p>" + //Date
                            " <p style=\"margin:0px;\">Company Name: <span>" + DSBooking.Tables[2].Rows[0][1].ToString() + "</span></p>" + //company name
                            " </td><td width=\"200\"><p style=\"margin:0px;\">Need help booking?</p>" +
                            " <p style=\"margin-top:0px;\">Call toll free <span style=\"color:orange; font-size:12px;\">1800-425-3454</span></p>" +
                            " </td></tr><tr><td width=\"600\" style=\"margin-bottom:\">" +
                            " <p style=\"color:orange; font-weight:bold; font-size:14px;\"> Guest Details</p>" +
                            " </td> </tr></table>";

                        string GuestDetailsTable2 =
                            " <table cellpadding=\"0\" cellspacing=\"0\" width=\"600\" border=\"0\" align=\"center\">" +
                            " <tr style=\"font-size:11px; font-weight:normal;\">" +
                            " <th style=\"background-color:#ccc; padding:6px 0px; border-right:1px solid #666;\"><p>Guest Name</p></th>" +
                            " <th style=\"background-color:#ccc; padding:6px 0px; border-right:1px solid #666;\"><p>Check-In Date / Expected Time</p></th>" +
                        ...
                        string AddressDtls2 =
                            ...
                            " <p style=\"margin-top:20px;\">" + DSBooking.Tables[2].Rows[0][8].ToString() + "" +
                            " </p><p style=\"margin-top:12px;\">" +
                            " <span style=\"color:#f54d02; font-weight:bold\">Route Map:</span> <br>" +
                            " </p></td></tr></table>";
                        ...
                        string QRCode1 =
                             ...
                             " <tr style=\"font-size:11px; font-weight:normal;\">" +
                             " <th width=\"200\" style=\"background-color:#eee; padding:5px 0px; border-right:1px solid #ccc;\"><p style=\"text-align:center; padding-left:10px;\">QR Code</p></th>" +
                             " <th width=\"200\" style=\"background-color:#eee; padding:5px 0px;\"><p style=\"text-align:center; padding-left:10px;\">Support</p></th>" +
                             " </tr><tr style=\"font-size:11px; font-weight:normal;\">" +
                             " <td width=\"200\" style=\"padding:10px; border-right:1px solid #ccc; margin-bottom:20px; border-bottom:1px solid #ccc;\">" +
                             "  <p style=\"color:orange; font-weight:bold; margin:0px; font-size:14px;\"> QR Code</p>" +
                             "  <br /><br />" +
                             ...
                             "    </p>" +
                             " </td><td width=\"200\" style=\"padding:10px; margin-bottom:20px; border-bottom:1px solid #ccc;\"> " +
                             " <p> Name:" + UserName1 + " </p> <p> Email:" + EmailId1 + " </p><p> Phone: " + PhoneNo1 + "</p></td>" +
                             " </tr></table>";
                        ...
                        string FooterDtls1 =
                             ...
                             " HUMMINGBIRD Corporate Travel and stay Pvt Ltd</p><br><hr>" +
                             " <p style=\"color:orange; font-weight:bold; margin:0px; font-size:11px; padding-top:20px;\">Disclaimer :</p>" +
                             " <p style=\"font-size:10px; padding-top:10px; padding-bottom:20px;\">" + Disclaimer1 + "</p>" +
                             " </td></tr> </table>";

                        message.Body = Imagebody1 + SecondRow1 + GuestDetailsTable2 + AddressDtls2 + QRCode1;
                        message.IsBodyHtml = true;
                        // SMTP Email email:
                        System.Net.Mail.SmtpClient smtp1 = new System.Net.Mail.SmtpClient();
                        smtp1.Host = "smtp.gmail.com";
