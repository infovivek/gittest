...
namespace HB.Dao
{
    public class CheckOutandInterSettleDtlDao
    {
        string UserData;
        ...
        public DataSet Save(string CheckOutSettleDtls, User user, int CheckOutSettleHdrId)
        {
            ...
            CheckOutandInterSettleDtl ChkOutSetDtl = new CheckOutandInterSettleDtl();
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                {
                    UserData = " UserId:" + user.Id + ", UsreName:" + user.LoginUserName + ", ScreenName:'" + user.ScreenName +
                "', SctId:" + user.SctId + ", Service:CheckOutInterSettleDtl_Insert" + ", ProcName:'" + StoredProcedures.CheckOutInterSettleDtl_Insert;

                    command.CommandText = StoredProcedures.CheckOutInterSettleDtl_Insert;
                }
