...
namespace HB.Dao
{
    public class ProformainvoiceServiceDtlsDao
    {
        string UserData;
        ...
        public DataSet Save(string CheckOutServiceDtls, User user, int CheckOutServceHdrId, int CheckOutHdrRowId)
        {
            ...
            ProformainvoiceServiceDtls ChkOutSerDtl = new ProformainvoiceServiceDtls();
            ...
            if (n != 0)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                  ...
                  "', SctId:" + user.SctId + ", Service:CheckOutHdrServiceDtl_Insert" + ", ProcName:'" + StoredProcedures.PreformaInvoiceServiceDtl_Insert;

                    command.CommandText = StoredProcedures.PreformaInvoiceServiceDtl_Insert;
                    //}
