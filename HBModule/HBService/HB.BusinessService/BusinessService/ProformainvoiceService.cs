...
{
    public class ProformainvoiceService : IBusinessService
    {
        ...
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                ds = new ProformainvoiceServicehdrBO().Save(Hdrval, user);
                ...
                else
                {
                    ...
                    DataSet ds1 = new ProformainvoiceServiceDtlsBO().Save(CheckOutServiceDtls, user, CheckOutServceHdrId, CheckOutHdrRowId);
        ...
        {
            return new ProformainvoiceServicehdrBO().HelpResult(data, user);
