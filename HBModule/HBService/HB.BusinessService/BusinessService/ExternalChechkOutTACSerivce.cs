...
{
    public class ExternalChechkOutTACSerivce:IBusinessService
    {
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                ds = new ExternalChechkOutTACBO().Save(data, user);
        ...
        {
            return new ExternalChechkOutTACBO().HelpResult(data, user);
        }
    }
}
