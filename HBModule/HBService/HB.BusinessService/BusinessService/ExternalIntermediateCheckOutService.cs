...
{
    public class ExternalIntermediateCheckOutService:IBusinessService
    {
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                ds = new ExternalIntermediateCheckOutBO().Save(data, user);
        ...
        {
            return new ExternalIntermediateCheckOutBO().HelpResult(data, user);
        }
    }
}
