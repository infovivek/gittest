...
{
    public class IntermediateCheckoutServiceHdrService : IBusinessService
    {
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                ds = new IntermediateCheckoutServiceHdrBO().Save(Hdrval, user);
                ...
                else
                {
                    ...
                    DataSet ds1 = new IntermediateCheckoutServiceDtlsBO().Save(CheckOutServiceDtls, user, CheckOutServceHdrId);
        ...
        {
            return new IntermediateCheckoutServiceHdrBO().HelpResult(data, user);
