...
{
    public class CheckOutandInterSettleService : IBusinessService
    {
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                ds = new CheckOutandInterSettleHdrBO().Save(Hdrval, user);
                ...
                else
                {
                    ...
                    DataSet ds1 = new CheckOutandInterSettleDtlBO().Save(CheckOutSettleDtls, user, CheckOutSettleHdrId);
