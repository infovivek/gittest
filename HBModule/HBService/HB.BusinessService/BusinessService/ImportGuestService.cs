...
{
    public class ImportGuestService : IBusinessService
    {
        ...
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
               ...
               // ClientId = Convert.ToInt32(data[2].ToString(););
                ds = new ImportGuestBO().Save(data, user);
        ...
        {
            return new ImportGuestBO().Search(data, user);
        }

        public DataSet HelpResult(string[] data, User user)
        {
            return new ImportGuestBO().HelpResult(data, user);
        }
    }
}
