...
{
    public class PreformaInvoiceIntenalchkoutService:IBusinessService
    {
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                ds = new PreformaInvoiceIntenalchkoutBO().Save(data, user);
        ...
        {
            return new PreformaInvoiceIntenalchkoutBO().Search(data, user);
        }

        public DataSet HelpResult(string[] data, User user)
        {
            return new PreformaInvoiceIntenalchkoutBO().HelpResult(data, user);
        }
    }
}
