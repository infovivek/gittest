...
{
    public class PreformaInvoiceEXTMMTCPPchkoutService : IBusinessService
    {
        ...
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                ds = new PreformaInvoiceEXTMMTCPPchkoutBO().Save(data, user);
        ...
        {
            return new PreformaInvoiceEXTMMTCPPchkoutBO().HelpResult(data, user);
        }
    }
}
