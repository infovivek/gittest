...
{
   public class BTCSubmissionService:IBusinessService
    {
        public DataSet Save(string[] data, Entity.User user)
        {
            ...
            try
            {
                ...
                ds = new BTCSubmissionBO().Save(data, user);
        ...
        public DataSet Search(string[] data, Entity.User user)
        {
            ...
            DataTable dTable = new DataTable("ERRORTBL");
            dTable.Columns.Add("Exception");
            ds = new BTCSubmissionBO().Search(data, user);
            return ds;
        }
        ...
        public DataSet HelpResult(string[] data, Entity.User user)
        {
            ...
            DataTable dTable = new DataTable("ERRORTBL");
            dTable.Columns.Add("Exception");
            ds = new BTCSubmissionBO().Help(data, user);
            return ds;
        }
    }
}
