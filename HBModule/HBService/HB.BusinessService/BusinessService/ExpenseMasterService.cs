...
{
    public class ExpenseMasterService : IBusinessService
    {
        public DataSet Save(string[] data, User user)
        {
            ...
            try
            {
                ...
                DataSet ds1 = new ExpenseMasterBO().Save(data, user);
        ...
        {
            return new ExpenseMasterBO().Search(data, user);
        }
        ...
        public DataSet HelpResult(string[] data, User user)
        {
            ...
            DataSet ds1 = new ExpenseMasterBO().Help(data, user);
            return ds1;
        }
    }
}
