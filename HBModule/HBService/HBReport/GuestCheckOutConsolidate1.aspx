<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuestCheckOutConsolidate1.aspx.cs" Inherits="HBReport.GuestCheckOutConsolidate1" %>
...
<body>
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="100%" 
            ...
            <LocalReport ReportPath="GuestCheckOutConsolidate1.rdlc">
                <DataSources>
