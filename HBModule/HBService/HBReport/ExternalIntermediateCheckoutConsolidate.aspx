<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExternalIntermediateCheckoutConsolidate.aspx.cs" Inherits="HBReport.ExternalIntermediateCheckoutConsolidate" %>
...
<body>
    ...
    <div style="margin-left: 400px">
        <asp:Button ID="Button1" runat="server" Text="Print" Width="70px" 
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="100%" 
            ...
            <LocalReport ReportPath="ExternalIntermediateCheckoutConsolidate.rdlc">
                <DataSources>
