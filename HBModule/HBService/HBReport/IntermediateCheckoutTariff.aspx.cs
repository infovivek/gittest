...
namespace HBReport
{
    public partial class IntermediateCheckoutTariff : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ds = new DataSet();
                command.CommandText = "SP_ProformaGuestCheckOutTariff_Bill";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("") + @"\IntermediateCheckoutTariff.rdlc";
