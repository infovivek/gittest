<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExternalIntermediateCheckoutService.aspx.cs" Inherits="HBReport.ExternalIntermediateCheckoutService" %>
...
<body>
    ...
    <div style="margin-left: 440px">
        <asp:Button ID="Button1" runat="server" Text="Print" Width="73px" 
    ...
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="100%" 
            ...
            <LocalReport ReportPath="ExternalIntermediateCheckoutService.rdlc">
                <DataSources>
