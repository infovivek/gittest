<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractBillDedicated.aspx.cs" Inherits="HBReport.ContractBillDedicated" %>
...
<body>
    ...
    <div style="margin-left: 440px">
        <asp:Button ID="Button1" runat="server" Text="Print" onclick="Button1_Click1" />
    </div>
    <div>
    </div>
    <div align="center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="100%" 
            ...
            <LocalReport ReportPath="ContractBillDedicated.rdlc">
                <DataSources>
