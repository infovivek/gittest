...
namespace HBReport
{
    public partial class CreditNoteTariffBill : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ds = new DataSet();
                command.CommandText = "SP_CreditNoteTariff_Bill";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("") + @"\CreditNoteTariffBill1.rdlc";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            filename = string.Format("{0}.{1}", "CreditNoteTariffBill", "pdf");
