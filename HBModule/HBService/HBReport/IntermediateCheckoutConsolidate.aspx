<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IntermediateCheckoutConsolidate.aspx.cs" Inherits="HBReport.IntermediateCheckoutConsolidate" %>
...
<body>
    ...
    <div style="margin-left: 400px">
        <asp:Button ID="Button1" runat="server" Text="Print" onclick="Button1_Click" 
            style="font-weight: 700" Width="60px" />
    </div>
    <div>
    </div>
    <div align = "center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="100%" 
            ...
            <LocalReport ReportPath="IntermediateCheckoutConsolidate.rdlc">
                <DataSources>
