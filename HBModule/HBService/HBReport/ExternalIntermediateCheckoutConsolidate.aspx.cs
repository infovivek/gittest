...
namespace HBReport
{
    public partial class ExternalIntermediateCheckoutConsolidate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("") + @"\ExternalIntermediateCheckoutConsolidate.rdlc";
