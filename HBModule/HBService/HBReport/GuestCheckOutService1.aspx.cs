...
namespace HBReport
{
    public partial class GuestCheckOutService1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ds = new DataSet();
                command.CommandText = "SP_ExtCheckOutService_Bill";
                ...
                command.Parameters.Add("@Id1", SqlDbType.Int).Value = asd[0];
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("") + @"\GuestCheckOutservice1.rdlc";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            filename = string.Format("{0}.{1}", "CheckOutTariffBill", "pdf");
