<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IntermediateCheckoutTariff.aspx.cs" Inherits="HBReport.IntermediateCheckoutTariff" %>
...
<body>
    ...
    <div align = "center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="100%" 
            ...
            <LocalReport ReportPath="IntermediateCheckoutTariff.rdlc">
                <DataSources>
