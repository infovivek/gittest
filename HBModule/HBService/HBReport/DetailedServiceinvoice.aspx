<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailedServiceinvoice.aspx.cs" Inherits="HBReport.DetailedServiceinvoice" %>
    ...
    <div align ="center">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="100%"  
            ...
            PromptAreaCollapsed="True" ShowExportControls="False">
             <LocalReport ReportPath="DetailedServiceinvoice.rdlc">
                <DataSources>
