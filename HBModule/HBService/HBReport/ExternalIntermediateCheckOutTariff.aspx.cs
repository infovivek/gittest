...
namespace HBReport
{
    public partial class ExternalIntermediateCheckOutTariff : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ds = new DataSet();
                command.CommandText = "SP_ProformaInvoiceExtChkOutTariff_Bill";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("") + @"\ExternalIntermediateCheckOutTariff.rdlc";
