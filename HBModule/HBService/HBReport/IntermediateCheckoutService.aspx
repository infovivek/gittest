<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IntermediateCheckoutService.aspx.cs" Inherits="HBReport.IntermediateCheckoutService" %>
...
<body>
    ...
    <div style="margin-left: 440px">
        <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="Print" 
            style="font-weight: 700" Width="53px" />
    </div>
    <div>
    </div>
    <div align = "center">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="100%" 
            ...
            <LocalReport ReportPath="IntermediateCheckoutService.rdlc">
                <DataSources>
