...
namespace HBReport
{
    public partial class IntermediateCheckoutConsolidate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ds = new DataSet();
                command.CommandText = "SP_ProformaInvoiceConsolidate_Bill";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("") + @"\IntermediateCheckoutConsolidate.rdlc";
