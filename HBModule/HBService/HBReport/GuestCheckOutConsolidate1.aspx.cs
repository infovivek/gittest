...
namespace HBReport
{
    public partial class GuestCheckOutConsolidate1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ds = new DataSet();
                command.CommandText = "SP_ExtCheckOutConsolidate_Bill";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("") + @"\GuestCheckOutConsolidate1.rdlc";
