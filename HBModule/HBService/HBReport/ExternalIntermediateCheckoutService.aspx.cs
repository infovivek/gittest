...
namespace HBReport
{
    public partial class ExternalIntermediateCheckoutService : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ds = new DataSet();
                command.CommandText = "SP_ProformainvoiceExtChkOutService_Bill";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("") + @"\ExternalIntermediateCheckoutService.rdlc";
