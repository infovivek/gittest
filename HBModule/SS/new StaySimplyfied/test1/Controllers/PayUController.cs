...
namespace test1.Controllers
{
    ...
    public class DropdownController : Controller
    {
        ...
        public JsonResult LoadBed2(Int64 PropertyId, Int64 bed1)
        {
            ...
            {
                var datas = (from s in db.SP_BookingPropertyDtls_Help_FrontEnd(checin, checout, cliendid, PropertyId, "Bed", "MGH")
                             where s.Id != bed1
                             select new
                             {
                                 s.label,
        ...
        public JsonResult LoadBed3(Int64 PropertyId, Int64 bed1, Int64 bed2)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
        ...
        public JsonResult LoadBed4(Int64 PropertyId, Int64 bed1, Int64 bed2, Int64 bed3)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
            ...
            {
                var datas = (from s in db.SP_BookingPropertyDtls_Help_FrontEnd(checin, checout, cliendid, PropertyId, "Bed", "MGH")
                             where s.Id != bed1 && s.Id != bed2 && s.Id != bed3
                             select new
                             {
                                 s.label,
                                 s.Id
        ...
        public JsonResult LoadBed5(Int64 PropertyId, Int64 bed1, Int64 bed2, Int64 bed3, Int64 bed4)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
            ...
            {
                var datas = (from s in db.SP_BookingPropertyDtls_Help_FrontEnd(checin, checout, cliendid, PropertyId, "Bed", "MGH")
                             where s.Id != bed1 && s.Id != bed2 && s.Id != bed3 && s.Id != bed4
                             select new
                             {
                                 s.label,
                                 s.Id
        ...
        public JsonResult LoadBed6(Int64 PropertyId, Int64 bed1, Int64 bed2, Int64 bed3, Int64 bed4, Int64 bed5)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
            ...
            {
                var datas = (from s in db.SP_BookingPropertyDtls_Help_FrontEnd(checin, checout, cliendid, PropertyId, "Bed", "MGH")
                             where s.Id != bed1 && s.Id != bed2 && s.Id != bed3 && s.Id != bed4 && s.Id != bed5
                             select new
                             {
                                 s.label,
                                 s.Id
        ...
        public JsonResult LoadBed7(Int64 PropertyId, Int64 bed1, Int64 bed2, Int64 bed3, Int64 bed4, Int64 bed5, Int64 bed6)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
        ...
        public JsonResult LoadBed8(Int64 PropertyId, Int64 bed1, Int64 bed2, Int64 bed3, Int64 bed4, Int64 bed5, Int64 bed6, Int64 bed7)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
        ...
        public JsonResult LoadBed9(Int64 PropertyId, Int64 bed1, Int64 bed2, Int64 bed3, Int64 bed4, Int64 bed5, Int64 bed6, Int64 bed7, Int64 bed8)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
        ...
        public JsonResult LoadBed10(Int64 PropertyId, Int64 bed1, Int64 bed2, Int64 bed3, Int64 bed4, Int64 bed5, Int64 bed6, Int64 bed7, Int64 bed8, Int64 bed9)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
            using (HBEntities db = new HBEntities())
            {
                var datas = (from s in db.SP_BookingPropertyDtls_Help_FrontEnd(checin, checout, cliendid, PropertyId, "Bed", "MGH")
                             where s.Id != bed1 && s.Id != bed2 && s.Id != bed3 && s.Id != bed4 && s.Id != bed5
                             && s.Id != bed6 && s.Id != bed7 && s.Id != bed8 && s.Id != bed9
                             select new
                             {
                                 s.label,
                                 s.Id
        ...
        public JsonResult LoadRoom2(Int64 PropertyId, Int64 room1)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
            using (HBEntities db = new HBEntities())
            {
                var datas = (from s in db.SP_BookingPropertyDtls_Help_FrontEnd(checin, checout, cliendid, PropertyId, "Room", "MGH")
                             where s.Id != room1 
                             select new
                             {
                                 s.label,
        ...
        public JsonResult LoadRoom3(Int64 PropertyId, Int64 room1, Int64 room2)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
        ...
        public JsonResult LoadRoom4(Int64 PropertyId, Int64 room1, Int64 room2, Int64 room3)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
            ...
            {
                var datas = (from s in db.SP_BookingPropertyDtls_Help_FrontEnd(checin, checout, cliendid, PropertyId, "Room", "MGH")
                             where s.Id != room1 && s.Id != room2 && s.Id != room3 
                             select new
                             {
                                 s.label,
                                 s.Id
        ...
        public JsonResult LoadRoom5(Int64 PropertyId, Int64 room1, Int64 room2, Int64 room3, Int64 room4)
        {
            long? cliendid = Session["client"] != null ? Convert.ToInt64(Session["client"]) : 0;
            string checin = Session["checindate"] != null ? Session["checindate"].ToString() : "";
            string checout = Session["checoutdate"] != null ? Session["checoutdate"].ToString() : "";
            ...
            {
                var datas = (from s in db.SP_BookingPropertyDtls_Help_FrontEnd(checin, checout, cliendid, PropertyId, "Room", "MGH")
                             where s.Id != room1 && s.Id != room2 && s.Id != room3 && s.Id != room4 
                             select new
                             {
                                 s.label,
                                 s.Id
        ...
        public ActionResult Roomids1(string ids)
        {
            return Json("", JsonRequestBehavior.AllowGet);
        }
        public JsonResult testing(string roomid)
        {
            using (HBEntities db = new HBEntities())
            {
        ...
        public ActionResult Roomids2(Int64 ids)
        {
            return Json("", JsonRequestBehavior.AllowGet);
        }
        public ActionResult Roomids3(Int64 ids)
        {
            return Json("", JsonRequestBehavior.AllowGet);
        }
        public ActionResult Roomids4(Int64 ids)
        {
            return Json("", JsonRequestBehavior.AllowGet);
        }
        public ActionResult Roomids5(Int64 ids)
        {
            return Json("", JsonRequestBehavior.AllowGet);
        }


        public ActionResult Bedids(Int64 ids)
        {
            return Json("", JsonRequestBehavior.AllowGet);
        }
    }
