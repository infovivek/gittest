        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include(
                      ...
                      "~/Scripts/jquery-ui.js",
                       "~/Scripts/alertify.js",
                        "~/Scripts/FixedTable1.js",
                        "~/Scripts/FixedTable2.js",
                        "~/Scripts/FixedTable3.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/css1").Include(
                      ...
                      "~/Content/css1/style-tab.css",
                      "~/Content/css1/style.css",
                      "~/Content/css1/bootstrap-theme.min.css",
                      "~/Content/css1/font-awesome.css"));


            bundles.Add(new StyleBundle("~/Content/css2").Include(

                      "~/Content/css2/colorbox.css",
                      "~/Content/css2/custom.css",
                      
                       "~/Content/css2/jquery.autocomplete.css",
                      "~/Content/css2/slider.css",
                      "~/Content/css2/easy-responsive-tabs1.css",
