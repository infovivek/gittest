...
private function useWeb(Action:String,CtrlNm:String,ParmArry:Array):void 
{
	...
	//ws.wsdl=arr[1].toString()+"/HMS_Service/HMSService.asmx?WSDL";
	//ws.wsdl=arr[1].toString()+"/TESTHMS_Service/HMSService.asmx?WSDL";
	//Alert.show(arr[0].toString()+"//"+arr[2].toString()+"/HR_Service/WarblerHRWebService.asmx?WSDL");
	//ws.wsdl="http://localhost/HR_Service/WarblerHRWebService.asmx?WSDL"
